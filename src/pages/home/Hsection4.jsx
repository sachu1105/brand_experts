    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:px-8 relative">
      ...
      >
        <div className="text-center mb-8 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-4">3-Step Design & Order Process</h2>
            ...
            >
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                ...
                <div className="sm:hidden w-full text-center">
                  <div className="text-6xl sm:text-9xl font-bold text-red-100 mb-4">{step.number}</div>
                  ...
                  {index % 2 === 0 ? (
                    <>
                      ...
                      <div className="flex-1 flex items-center gap-8">
                        <div className="w-32">
                          <div className="text-9xl font-bold text-red-100">{step.number}</div>
                        </div>
