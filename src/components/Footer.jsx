          ...
          <div className="mx-auto max-w-screen-xl">
              ...
              <div className="mb-6 md:mb-0">
                <a href="/" className="flex items-center">
                  <picture>
                    ...
                    <img
                      src={footerLogoPng}
                      className="mr-24 h-24 sm:h-34 w-48 sm:w-screen "
                      alt="Footer Logo"
                    />
                  </picture>
                </a>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3  ml-14">
                {/* About Us Section */}
                <div className="text-white">
                  ...
                  <p className="  text-sm">
                    ...
                    as canvas prints, car decals, viny/ lettering and acrylic
                    displays.
                  </p>
                </div>
                ...
                <div className="text-white">
                  ...
                  <div className=" ">
                    <p className="mb-4">1234567891</p>
                    <p className="mb-4">demo@gmail.com</p>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center ">
                Copyright © 2025 Branch Experts. All Rights Reserved.
              </span>
