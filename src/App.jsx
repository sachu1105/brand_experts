          ...
          <Router>
            <Routes>
              <Route element={<Layout />}>
                ...
                <Route path="/shared-orders" element={<h1>Shared Orders</h1>} />
                ...
                <Route path="/email-notifications" element={<h1>Email Notifications</h1>}/>
                <Route path="/profile-password" element={<h1>Profile & Password</h1>}/>
              </Route>
            </Routes>
          </Router>
        </div>
